...
const DetailedPayerFilter = ({showAll, accountName, onDateInput, onKontoInput, onProgramInput, onAmountInput, onRecipientInput}) => {
    ...
    return (
        <div>
            ...
            <div id="account-label">
                <h6>Трансакции на {accountName} како давател</h6>
                <Link onClick={showAll}><h6 id="see-all">Прикажи ги сите <span className="fa fa-chevron-down"></span></h6></Link>
                <hr/>
            </div>
            <div className="row" id="payer-label-container">
                <div className="col">
                    <h6>Датум</h6>
                </div>
                <div className="col">
            ...
            <div className="row" id="payer-filter-container">
                <div className="col">
                    <DayPickerInput
                        id="from"
                ...
                <div className="col">
                    <input className="form-control" placeholder="Давател" disabled="true"></input>
                </div>
                <div className="col">
                    <input className="form-control" placeholder="Сметка" disabled="true"></input>
                </div>
                <div className="col">
                    <div className="row">
                        <div className="col">
                ...
                <div className="col">
                    <input className="form-control" placeholder="Примател" onKeyDown={onRecipientInput}></input>
                </div>
                <div className="col">
                    <div className="row">
                        <div className="col">
...
export default DetailedPayerFilter;