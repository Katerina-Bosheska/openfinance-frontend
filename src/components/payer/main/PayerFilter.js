...
const PayerFilter = ({onShowAll, onNameInput, onBillInput, onEdbInput, onAmountInput }) => {
    ...
    return (
        <div>
            ...
            <div className="row" id="payer-filter-container">
                ...
                <div className="col">
                    <input className="form-control" on placeholder="Сметка" onKeyDown={onBillInput}></input>
                </div>
                <div className="col">
